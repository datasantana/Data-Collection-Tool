        ...
        <v-list-item link> 
          ...
          <v-list-item-content>
            <v-list-item-title>
              ...
              <p class="overline">{{ user.email.substring(0, user.email.indexOf("@")) }}</p>
            </v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        <v-divider></v-divider>
    ...
    <v-app-bar app color="blue-grey-darken-4" dark>
      ...
      <v-menu left>
        <template v-slot:activator="{ on }">
          <v-btn  id="v-step-6" class="overline" icon v-on="on">Ayuda<v-icon size=14 >mdi-help-circle</v-icon>
          </v-btn>
        </template>
        <v-list>
          <v-list-item to="/about">
            <v-list-item-title class="overline">Guía de usuario</v-list-item-title>
          </v-list-item>
          <v-list-item to="/question">
            <v-list-item-title class="overline">Preguntas Frecuentes</v-list-item-title>
          </v-list-item>
      ...
      <v-menu left>
        ...
        <v-list>
          <v-list-item @click="logout">
            <v-list-item-title class="overline">Cerrar Sesión</v-list-item-title>
          </v-list-item>
        </v-list>
      </v-menu>
